...
//			holder.lastChangeUserAvatar = (ImageView) vi.findViewById(R.id.logAlarmAvatar);
		...
		if (data.size() <= 0) {
			...
			holder.actualKm.setText(String.valueOf(iterAlarm.getKm())); // TODO formatear con ,
			...
			holder.lastServiceDate.setText(iterAlarm.getLastservicedateString().toString()); // TODO que esto vaya como String
			holder.lastServiceKm.setText(String.valueOf(iterAlarm.getLastservicekm())); // TODO formatear con ,
