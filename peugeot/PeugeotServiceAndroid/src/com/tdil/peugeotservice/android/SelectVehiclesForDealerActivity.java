...
public class SelectVehiclesForDealerActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new RESTClientTask(this, HttpMethod.GET, new IRestClientObserver() {
			...
			public void sucess(IRestClientTask task) {
				...
				adapter = new SelectVehiclesForDealerListAdapter(SelectVehiclesForDealerActivity.this,
