package com.tdil.peugeotservice.android.car.menu;
...
import com.tdil.peugeotservice.android.car.CarsParkedModeOnClick;
import com.tdil.peugeotservice.android.car.CarsPathOnClick;
import com.tdil.peugeotservice.android.car.CarsPhoneOnClick;
import com.tdil.peugeotservice.android.car.CarsPositionsOnClick;
import com.tdil.peugeotservice.android.car.CarsSpeedOnClick;
import com.tdil.peugeotservice.android.car.CarsZoneOnClick;
...
//		carParkedModeButtonMenu.layout(leftSeptimoBoton, topSeptimoBoton, leftSeptimoBoton + widthAndHeightBoton, topSeptimoBoton + widthAndHeightBoton);
		...
		ImageView carMenuOpenButton = (ImageView)getChildAt(6); // 
		...
		if (menuListener == null) {
			if (this.activity instanceof ActivityCars) {
				...
				menuListener = new ToggleCarsMenuOnClick(true, this, menuImage, carMenuOpenButton, carPositionsButtonMenu, carSpeedButtonMenu, carZoneButtonMenu, 
						carPhoneButtonMenu, carPathButtonMenu);
