...
public class Geo2DAOImpl implements Geo2DAO {
	...
	public GeoLevelValueObject selectGeoLevelsByGeo2(int id) throws SQLException {
		GeoLevelValueObject list = (GeoLevelValueObject)sqlMapClient.queryForObject("GEO2.selectGeoLevel2ById", id);
		return list;
	}
}