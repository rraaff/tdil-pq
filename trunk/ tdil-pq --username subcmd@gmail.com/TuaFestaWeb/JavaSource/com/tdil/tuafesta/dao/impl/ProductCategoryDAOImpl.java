...
public class ProductCategoryDAOImpl implements ProductCategoryDAO {
     ...
     * This field corresponds to the database table PROF_PROD_CATEGORY
     *
    ...
    public ProductCategory selectProductCategoryByPrimaryKey(Integer id) throws SQLException {
        ProductCategory _key = new ProductCategory();
        _key.setId(id);
        ProductCategory record = (ProductCategory) sqlMapClient.queryForObject("PROF_PROD_CATEGORY.selectByPrimaryKey", _key);
        return record;
    }
     ...
     * @mbggenerated Fri Aug 03 18:15:40 ART 2012
     */
    public int updateProductCategoryByExampleSelective(ProductCategory record, ProductCategoryExample example) throws SQLException {
     ...
     * @mbggenerated Fri Aug 03 18:15:40 ART 2012
     */
    public int updateProductCategoryByExample(ProductCategory record, ProductCategoryExample example) throws SQLException {
        UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
     ...
     * This class corresponds to the database table PROF_PROD_CATEGORY
     *
     * @mbggenerated Fri Aug 03 18:15:40 ART 2012
     */
