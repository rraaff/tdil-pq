...
public class HighlightedProfesionalDAOImpl implements HighlightedProfesionalDAO {
     ...
     * This field corresponds to the database table HIGHLIGHTED_PROF
     *
     ...
     * This method corresponds to the database table HIGHLIGHTED_PROF
     *
     * @mbggenerated Sun Aug 26 20:37:47 ART 2012
     */
    ...
    public List<HighlightedProfesional> selectHighlightedProfesionalByExample(HighlightedProfesionalExample example) throws SQLException {
    ...
    public HighlightedProfesional selectHighlightedProfesionalByPrimaryKey(Integer id) throws SQLException {
        HighlightedProfesional _key = new HighlightedProfesional();
        _key.setId(id);
        HighlightedProfesional record = (HighlightedProfesional) sqlMapClient.queryForObject("HIGHLIGHTED_PROF.selectByPrimaryKey", _key);
        return record;
    }
     ...
     * @mbggenerated Sun Aug 26 20:37:47 ART 2012
     */
    public int updateHighlightedProfesionalByExampleSelective(HighlightedProfesional record, HighlightedProfesionalExample example) throws SQLException {
     ...
     * @mbggenerated Sun Aug 26 20:37:47 ART 2012
     */
    public int updateHighlightedProfesionalByExample(HighlightedProfesional record, HighlightedProfesionalExample example) throws SQLException {
        UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
