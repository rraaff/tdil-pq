...
public class ServiceCategoryDAOImpl implements ServiceCategoryDAO {
    ...
    public ServiceCategory selectServiceCategoryByPrimaryKey(Integer id) throws SQLException {
        ServiceCategory _key = new ServiceCategory();
        _key.setId(id);
        ServiceCategory record = (ServiceCategory) sqlMapClient.queryForObject("PROF_SERV_CATEGORY.selectByPrimaryKey", _key);
        return record;
    }
     ...
     * @mbggenerated Fri Aug 03 18:15:40 ART 2012
     */
    public int updateServiceCategoryByExampleSelective(ServiceCategory record, ServiceCategoryExample example) throws SQLException {
     ...
     * @mbggenerated Fri Aug 03 18:15:40 ART 2012
     */
    public int updateServiceCategoryByExample(ServiceCategory record, ServiceCategoryExample example) throws SQLException {
        UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
