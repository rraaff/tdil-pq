...
public class DisapproveProfesionalBusinessDataChangeAction extends AbstractAction {

	private static final Logger LOG = LoggerProvider.getLogger(DisapproveProfesionalBusinessDataChangeAction.class);
		...
		try {
			TransactionProvider.executeInTransaction(new TransactionalAction() {
				public void executeInTransaction() throws SQLException, ValidationException {
					approveDisapproveForm.disapproveBusinessDataChange();
				}
			});
