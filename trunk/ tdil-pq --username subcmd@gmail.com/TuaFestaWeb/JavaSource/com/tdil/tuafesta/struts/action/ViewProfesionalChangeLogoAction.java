...
public class ViewProfesionalChangeLogoAction extends AbstractAction {

	@Override
	protected ActionForward basicExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		ReviewProfesionalForm noteForm = (ReviewProfesionalForm) form;
		UploadData uploadData = noteForm.getChangeLogo();
