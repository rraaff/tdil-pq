...
public class BannerPositionDAOImpl implements BannerPositionDAO {
     ...
     * This field corresponds to the database table BANNER_POSITION
     *
     ...
     * This method corresponds to the database table BANNER_POSITION
     *
     * @mbggenerated Wed Apr 25 07:29:57 ART 2012
     */
    ...
    public BannerPosition selectBannerPositionByPrimaryKey(Integer id) throws SQLException {
        BannerPosition _key = new BannerPosition();
        _key.setId(id);
        BannerPosition record = (BannerPosition) sqlMapClient.queryForObject("BANNER_POSITION.selectByPrimaryKey", _key);
        return record;
    }
     ...
     * @mbggenerated Wed Apr 25 07:29:57 ART 2012
     */
    public int updateBannerPositionByExampleSelective(BannerPosition record, BannerPositionExample example) throws SQLException {
