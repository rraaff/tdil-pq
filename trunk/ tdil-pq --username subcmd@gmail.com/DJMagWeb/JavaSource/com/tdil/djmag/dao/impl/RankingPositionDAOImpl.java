...
public class RankingPositionDAOImpl implements RankingPositionDAO {
     ...
     * This field corresponds to the database table RANKING_POSITION
     *
    ...
    public List<RankingPosition> selectRankingPositionByExampleWithBLOBs(RankingPositionExample example) throws SQLException {
     ...
     */
    @SuppressWarnings("unchecked")
    public List<RankingPosition> selectRankingPositionByExampleWithoutBLOBs(RankingPositionExample example) throws SQLException {
    ...
    public RankingPosition selectRankingPositionByPrimaryKey(Integer id) throws SQLException {
        RankingPosition _key = new RankingPosition();
        _key.setId(id);
        RankingPosition record = (RankingPosition) sqlMapClient.queryForObject("RANKING_POSITION.selectByPrimaryKey", _key);
        return record;
    }
     ...
     * @mbggenerated Thu May 17 12:17:02 ART 2012
     */
    public int updateRankingPositionByExampleSelective(RankingPosition record, RankingPositionExample example) throws SQLException {
     ...
     * @mbggenerated Thu May 17 12:17:02 ART 2012
     */
    public int updateRankingPositionByExampleWithBLOBs(RankingPosition record, RankingPositionExample example) throws SQLException {
        UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
     ...
     * @mbggenerated Thu May 17 12:17:02 ART 2012
     */
    public int updateRankingPositionByExampleWithoutBLOBs(RankingPosition record, RankingPositionExample example) throws SQLException {
        UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
