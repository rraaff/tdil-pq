...
public class RankingNoteCountryDAOImpl implements RankingNoteCountryDAO {
     ...
     * This field corresponds to the database table RANKING_NOTE_COUNTRY
     *
    ...
    public List<RankingNoteCountry> selectRankingNoteCountryByExample(RankingNoteCountryExample example) throws SQLException {
    ...
    public RankingNoteCountry selectRankingNoteCountryByPrimaryKey(Integer id) throws SQLException {
        RankingNoteCountry _key = new RankingNoteCountry();
        _key.setId(id);
        RankingNoteCountry record = (RankingNoteCountry) sqlMapClient.queryForObject("RANKING_NOTE_COUNTRY.selectByPrimaryKey", _key);
        return record;
    }
     ...
     * @mbggenerated Fri Apr 13 23:51:06 ART 2012
     */
    public int updateRankingNoteCountryByExampleSelective(RankingNoteCountry record, RankingNoteCountryExample example) throws SQLException {
     ...
     * @mbggenerated Fri Apr 13 23:51:06 ART 2012
     */
    public int updateRankingNoteCountryByExample(RankingNoteCountry record, RankingNoteCountryExample example) throws SQLException {
        UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
