...
public class UploadNoteNewsCoverAction extends AbstractAction {
	...
	protected ActionForward basicExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		try {
			noteForm.uploadNewsCover(error);
			if(error.hasError()) {
	...
	private static Logger getLog() {
		return LoggerProvider.getLogger(UploadNoteNewsCoverAction.class);
	}
