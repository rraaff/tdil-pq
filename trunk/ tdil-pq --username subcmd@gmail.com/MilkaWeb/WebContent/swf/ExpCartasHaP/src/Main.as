package  src{
	...
	public class Main extends MovieClip {
		...
		//private var uploadGraphic:Loader = new Loader();
		...
		//private var upload_picture:String;
		private var previous_picture:String;
		private var play_picture:String;
		private var pause_picture:String;
		//private var vURLtoUploads:String = root.loaderInfo.parameters.URLtoUploads;
		...
		private function init(e:Event=null){
			...
			slider.addChild(background_mc);
			slider.addChild(baseDibujos_mc);
		...
		private function processXML(e:Event){
			...
			//upload_picture = String ( xmlFile.info.uploadButton );
		...
		*/
		...
		private function create_info(){
			...
			var nextButton:MovieClip = new MovieClip();
				...
				nextButton.y = -(slider_height/2)-50;
				nextButton.x = 400;
			...
			var nextHotspot:MovieClip = new MovieClip();
				...
				nextHotspot.graphics.drawRect(0,0,button_size,button_size);
			...
			var previousButton:MovieClip = new MovieClip();
				previousButton.y = -(slider_height/2)-50;//(info_height-button_size)/2;
				previousButton.x = -300;
			...
			var previousHotspot:MovieClip = new MovieClip();
				...
				previousHotspot.graphics.drawRect(0,0,button_size,button_size);
			...
			var playpauseButton:MovieClip = new MovieClip();
				playpauseButton.x=-2000;//info_width+button_size+((slider_width-info_width)/2-button_size)/2;
				playpauseButton.y=-2000;//(info_height-button_size)/2;
			...
			var playpauseHotspot:MovieClip = new MovieClip();
				...
				playpauseHotspot.graphics.drawRect(0,0,button_size,button_size);
		...
		private function check_content(e:Event){
			...
			/*if (uploadGraphic.contentLoaderInfo.bytesTotal>0){
				bytes_total += uploadGraphic.contentLoaderInfo.bytesTotal;
				bytes_loaded += uploadGraphic.contentLoaderInfo.bytesLoaded;
			}
			else
				load_ok = false;
			*/
