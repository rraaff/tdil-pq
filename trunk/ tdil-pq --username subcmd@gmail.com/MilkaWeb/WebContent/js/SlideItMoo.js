...
var SlideItMoo = new Class({
	...
	setContainersSize: function(){
		$(this.options.overallContainer).set({
			styles:{
				'width': this.options.itemsVisible * this.image_size.x + 115*this.options.showControls + (this.options.itemsVisible-1)*3
			}
		});
		$(this.options.elementScrolled).set({
			styles:{
				'width': 30 + this.options.itemsVisible * this.image_size.x + (this.options.itemsVisible-1)*3
			}
		});
	},
