...
<div id="container">
	...
	<div class="renglon width860">
		<display:table name="test" sort="external" pagesize="10" id="testit" requestURI="./milkaPhotoPending.jsp">
			...
			<display:column title="acciones"><a href="./reviewMilkaPhoto.do?id=<%= ((MilkaPhotoValueObject)pageContext.getAttribute("testit")).getId()%>&page=<%= request.getParameter("page") != null ? request.getParameter("page") : "1" %>">Revisar</a></display:column>
		</display:table>
	</div>
