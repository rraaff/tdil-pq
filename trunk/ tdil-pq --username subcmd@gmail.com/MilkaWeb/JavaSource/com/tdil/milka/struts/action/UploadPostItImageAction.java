...
public class UploadPostItImageAction extends AjaxFileUploadAction {

	@Override
	protected AjaxUploadHandlerForm getUploadForm(HttpServletRequest request, ActionForm form) {
		return (AjaxUploadHandlerForm)request.getSession().getAttribute("PostItAdministrationForm");
	}
