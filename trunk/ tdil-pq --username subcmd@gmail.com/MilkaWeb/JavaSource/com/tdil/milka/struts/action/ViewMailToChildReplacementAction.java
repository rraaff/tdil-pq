...
import com.tdil.milka.struts.forms.MailToChildAdministrationForm;
import com.tdil.struts.actions.AbstractAction;
import com.tdil.struts.forms.UploadData;

public class ViewMailToChildReplacementAction extends AbstractAction {

	@Override
	protected ActionForward basicExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		MailToChildAdministrationForm noteForm = (MailToChildAdministrationForm) form;
