...
import com.tdil.struts.forms.ITransactionalActionForm;
import com.tdil.struts.resources.ApplicationResources;
import com.tdil.subsystem.generic.GenericTransactionExecutionService;
import com.tdil.validations.ValidationErrors;

public class SaveActionI extends AbstractAction {

	private static final class ResetAndInit implements TransactionalAction {
		private final ITransactionalActionForm form;

		private ResetAndInit(ITransactionalActionForm form) {
			this.form = form;
		}
	...
	private static final class Save implements TransactionalAction {
		...
		private Save(ITransactionalActionForm form) {
			this.form = form;
		}
	...
	protected ActionForward basicExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		ITransactionalActionForm aForm = (ITransactionalActionForm)form;
	...
	public ActionForward validateAndSave(final ITransactionalActionForm form, HttpServletRequest request, ActionMapping mapping) {
	...
	protected ActionForward getSucessForward(ITransactionalActionForm form, ActionMapping mapping) {
		return mapping.findForward("continue");
	}
