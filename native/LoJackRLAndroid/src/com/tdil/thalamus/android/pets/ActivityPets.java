package com.tdil.thalamus.android.pets;
...
public class ActivityPets extends LoJackLoggedActivity {
	
	public static String PETS_URL = "PETS_URL";
	...
	public class GeoWebChromeClient extends WebChromeClient {
		...
		public void onProgressChanged(WebView view, int newProgress) {
			...
			ActivityPets.this.setProgress(newProgress * 100);
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		String urlToOpen = extras.getString(PETS_URL);
		if (urlToOpen.contains("?")) {
			urlToOpen = urlToOpen + "&fromLoApp=1&android=1";
		} else {
			urlToOpen = urlToOpen + "?fromLoApp=1&android=1";
		}
