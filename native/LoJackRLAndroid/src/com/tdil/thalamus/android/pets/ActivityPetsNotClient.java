...
public class ActivityPetsNotClient extends LoJackLoggedActivity {
	...
	public class GeoWebChromeClient extends WebChromeClient {
		...
		public void onProgressChanged(WebView view, int newProgress) {
			...
			ActivityPetsNotClient.this.setProgress(newProgress * 100);
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			webView.loadUrl(ApplicationConfig.URL_PETS_NOT_CLIENT + "?apkToken=" + Login.getLoggedUser(this).getApkToken());
		} catch (Exception e) {
