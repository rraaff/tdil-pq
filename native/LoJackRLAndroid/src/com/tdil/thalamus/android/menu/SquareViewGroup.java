...
*/	
		...
		// Posicion item 6 TOP: 50,00% LEFT: 10,70%
		...
		// Posicion item 7 TOP: a ver por pablo
		int widthAndHeightBadge = BigDecimal.valueOf(width).multiply(BigDecimal.valueOf(10)).divide(BigDecimal.valueOf(100)).intValue();
		int topSeptimoBoton = BigDecimal.valueOf(width).multiply(BigDecimal.valueOf(22.80)).divide(BigDecimal.valueOf(100)).intValue();
		int leftSeptimoBoton = BigDecimal.valueOf(width).multiply(BigDecimal.valueOf(22.20)).divide(BigDecimal.valueOf(100)).intValue();
