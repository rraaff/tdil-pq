 ...
 * well.
 */
public class LegalesLoggedActivity extends LoJackLoggedActivity {
	...
	public class GeoWebChromeClient extends WebChromeClient {
		...
		public void onProgressChanged(WebView view, int newProgress) {
			...
			LegalesLoggedActivity.this.setProgress(newProgress * 100);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_legales_logged);
		customizeActionBar();
