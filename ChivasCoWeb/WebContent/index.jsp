...
<div id="structure">
	...
	<div id="footer">
		<div id="signInButtons">
			<ul>
				<li class="sib_thalamus"><a href="javascript:register();" id="register" title="Register Now!"></a></li>
				<li class="sib_facebook"><a href="<%=ThalamusClientBeanFacade.getFacebookLogin().getUrl()%>" id="fb" title="Register with your Facebook account!"></a></li>
				<li class="sib_twitter"><a href="<%= twitterUrl.getUrl()%>" id="fb" title="Register with your Twitter account!"></a></li>
				<li class="sib_participate"><img src="images/skin_nrg2/buttons/title_participate.png"></li>
			</ul>
		</div>
		<div class="menuNotAnUser">
			<ul>
				...
				<li><a href="< % = twitterUrl.getUrl()%>" id="fb" title="Register Now!">Twitter</a></li-->
	...
	<div class="registerLayerStyles">
		<div class="registerLayerContent">
			...
			<html:form method="POST" action="/register">
				...
				<logic:iterate id="dynamicField" name="RegisterForm" property="dynamicFields">
	...
	<div class="resetPassLayerStyles">
		<div class="resetPassLayerContent">
			<html:form method="POST" action="/requestResetPassword">
				<div class="myRow">
					<div class="myLabel width40">&nbsp;</div>
					<div class="myLabel width100">User/E-Mail</div>
					<div class="myLabel width250"><html:text name="RequestResetPasswordForm" property="username" styleClass="normalField width250"/></div>
				</div>
				<div class="myRow">
