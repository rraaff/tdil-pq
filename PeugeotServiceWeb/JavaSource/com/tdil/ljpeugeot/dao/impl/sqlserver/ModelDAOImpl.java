...
public class ModelDAOImpl implements ModelDAO {
	...
	/**
	 * This field was generated by MyBatis Generator. This field corresponds to the database table dbo.MODEL
	...
	public int countModelByExample(ModelExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject("dbo_MODEL.countByExample", example);
		return count;
	}
	...
	public int deleteModelByExample(ModelExample example) throws SQLException {
		int rows = sqlMapClient.delete("dbo_MODEL.deleteByExample", example);
		return rows;
	}
	...
	public int deleteModelByPrimaryKey(Integer id) throws SQLException {
		...
		_key.setId(id);
		int rows = sqlMapClient.delete("dbo_MODEL.deleteByPrimaryKey", _key);
		return rows;
	}
	...
	public Integer insertModel(Model record) throws SQLException {
		Object newKey = sqlMapClient.insert("dbo_MODEL.insert", record);
	...
	public Integer insertModelSelective(Model record) throws SQLException {
		Object newKey = sqlMapClient.insert("dbo_MODEL.insertSelective", record);
		return (Integer) newKey;
	}
	...
	public List<Model> selectModelByExample(ModelExample example) throws SQLException {
		List<Model> list = sqlMapClient.queryForList("dbo_MODEL.selectByExample", example);
		return list;
	}
	...
	public Model selectModelByPrimaryKey(Integer id) throws SQLException {
		Model _key = new Model();
		_key.setId(id);
		Model record = (Model) sqlMapClient.queryForObject("dbo_MODEL.selectByPrimaryKey", _key);
		return record;
	}
	...
	public int updateModelByExampleSelective(Model record, ModelExample example) throws SQLException {
		...
		int rows = sqlMapClient.update("dbo_MODEL.updateByExampleSelective", parms);
		return rows;
	}
	...
	public int updateModelByExample(Model record, ModelExample example) throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = sqlMapClient.update("dbo_MODEL.updateByExample", parms);
		return rows;
	}
	...
	public int updateModelByPrimaryKeySelective(Model record) throws SQLException {
		int rows = sqlMapClient.update("dbo_MODEL.updateByPrimaryKeySelective", record);
		return rows;
	}
	...
	public int updateModelByPrimaryKey(Model record) throws SQLException {
		int rows = sqlMapClient.update("dbo_MODEL.updateByPrimaryKey", record);
		return rows;
	}

	/**
	 * This class was generated by MyBatis Generator. This class corresponds to the database table dbo.MODEL
	 * @mbggenerated  Fri Jan 31 19:32:03 ART 2014
	 */
