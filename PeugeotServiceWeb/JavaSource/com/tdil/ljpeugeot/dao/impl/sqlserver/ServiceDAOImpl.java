...
public class ServiceDAOImpl implements ServiceDAO {
	...
	/**
	 * This field was generated by MyBatis Generator. This field corresponds to the database table dbo.SERVICE
	...
	public int countServiceByExample(ServiceExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject("dbo_SERVICE.countByExample", example);
		return count;
	}
	...
	public int deleteServiceByExample(ServiceExample example) throws SQLException {
		int rows = sqlMapClient.delete("dbo_SERVICE.deleteByExample", example);
		return rows;
	}
	...
	public int deleteServiceByPrimaryKey(Integer id) throws SQLException {
		...
		_key.setId(id);
		int rows = sqlMapClient.delete("dbo_SERVICE.deleteByPrimaryKey", _key);
		return rows;
	}
	...
	public Integer insertService(Service record) throws SQLException {
		Object newKey = sqlMapClient.insert("dbo_SERVICE.insert", record);
	...
	public Integer insertServiceSelective(Service record) throws SQLException {
		Object newKey = sqlMapClient.insert("dbo_SERVICE.insertSelective", record);
		return (Integer) newKey;
	}
	...
	public List<Service> selectServiceByExample(ServiceExample example) throws SQLException {
		List<Service> list = sqlMapClient.queryForList("dbo_SERVICE.selectByExample", example);
		return list;
	}
	...
	public Service selectServiceByPrimaryKey(Integer id) throws SQLException {
		Service _key = new Service();
		_key.setId(id);
		Service record = (Service) sqlMapClient.queryForObject("dbo_SERVICE.selectByPrimaryKey", _key);
		return record;
	}
	...
	public int updateServiceByExampleSelective(Service record, ServiceExample example) throws SQLException {
		...
		int rows = sqlMapClient.update("dbo_SERVICE.updateByExampleSelective", parms);
		return rows;
	}
	...
	public int updateServiceByExample(Service record, ServiceExample example) throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = sqlMapClient.update("dbo_SERVICE.updateByExample", parms);
		return rows;
	}
	...
	public int updateServiceByPrimaryKeySelective(Service record) throws SQLException {
		int rows = sqlMapClient.update("dbo_SERVICE.updateByPrimaryKeySelective", record);
		return rows;
	}
	...
	public int updateServiceByPrimaryKey(Service record) throws SQLException {
		int rows = sqlMapClient.update("dbo_SERVICE.updateByPrimaryKey", record);
		return rows;
	}

	/**
	 * This class was generated by MyBatis Generator. This class corresponds to the database table dbo.SERVICE
	 * @mbggenerated  Fri Jan 31 19:32:03 ART 2014
	 */
