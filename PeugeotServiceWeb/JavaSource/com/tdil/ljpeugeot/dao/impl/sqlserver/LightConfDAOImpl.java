...
public class LightConfDAOImpl implements LightConfDAO {
	...
	/**
	 * This field was generated by MyBatis Generator. This field corresponds to the database table dbo.LIGHT_CONF
	...
	public int countLightConfByExample(LightConfExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject("dbo_LIGHT_CONF.countByExample", example);
		return count;
	}
	...
	public int deleteLightConfByExample(LightConfExample example) throws SQLException {
		int rows = sqlMapClient.delete("dbo_LIGHT_CONF.deleteByExample", example);
		return rows;
	}
	...
	public int deleteLightConfByPrimaryKey(Integer id) throws SQLException {
		...
		_key.setId(id);
		int rows = sqlMapClient.delete("dbo_LIGHT_CONF.deleteByPrimaryKey", _key);
		return rows;
	}
	...
	public Integer insertLightConf(LightConf record) throws SQLException {
		Object newKey = sqlMapClient.insert("dbo_LIGHT_CONF.insert", record);
	...
	public Integer insertLightConfSelective(LightConf record) throws SQLException {
		Object newKey = sqlMapClient.insert("dbo_LIGHT_CONF.insertSelective", record);
		return (Integer) newKey;
	}
	...
	public List<LightConf> selectLightConfByExample(LightConfExample example) throws SQLException {
		List<LightConf> list = sqlMapClient.queryForList("dbo_LIGHT_CONF.selectByExample", example);
		return list;
	}
	...
	public LightConf selectLightConfByPrimaryKey(Integer id) throws SQLException {
		LightConf _key = new LightConf();
		_key.setId(id);
		LightConf record = (LightConf) sqlMapClient.queryForObject("dbo_LIGHT_CONF.selectByPrimaryKey", _key);
		return record;
	}
	...
	public int updateLightConfByExampleSelective(LightConf record, LightConfExample example) throws SQLException {
		...
		int rows = sqlMapClient.update("dbo_LIGHT_CONF.updateByExampleSelective", parms);
		return rows;
	}
	...
	public int updateLightConfByExample(LightConf record, LightConfExample example) throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = sqlMapClient.update("dbo_LIGHT_CONF.updateByExample", parms);
		return rows;
	}
	...
	public int updateLightConfByPrimaryKeySelective(LightConf record) throws SQLException {
		int rows = sqlMapClient.update("dbo_LIGHT_CONF.updateByPrimaryKeySelective", record);
		return rows;
	}
	...
	public int updateLightConfByPrimaryKey(LightConf record) throws SQLException {
		int rows = sqlMapClient.update("dbo_LIGHT_CONF.updateByPrimaryKey", record);
		return rows;
	}

	/**
	 * This class was generated by MyBatis Generator. This class corresponds to the database table dbo.LIGHT_CONF
	 * @mbggenerated  Fri Jul 05 18:45:21 ART 2013
	 */
