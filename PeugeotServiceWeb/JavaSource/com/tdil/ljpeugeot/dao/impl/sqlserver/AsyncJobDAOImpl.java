...
import com.tdil.ljpeugeot.model.AsyncJob;
import com.tdil.ljpeugeot.model.AsyncJobExample;

public class AsyncJobDAOImpl implements AsyncJobDAO {

	/**
	 * This field was generated by MyBatis Generator. This field corresponds to the database table dbo.ASYNC_JOB
	...
	public int countAsyncJobByExample(AsyncJobExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject("dbo_ASYNC_JOB.countByExample", example);
		return count;
	}
	...
	public int deleteAsyncJobByExample(AsyncJobExample example) throws SQLException {
		int rows = sqlMapClient.delete("dbo_ASYNC_JOB.deleteByExample", example);
		return rows;
	}
	...
	public int deleteAsyncJobByPrimaryKey(Integer id) throws SQLException {
		...
		_key.setId(id);
		int rows = sqlMapClient.delete("dbo_ASYNC_JOB.deleteByPrimaryKey", _key);
		return rows;
	}
	...
	public Integer insertAsyncJob(AsyncJob record) throws SQLException {
		Object newKey = sqlMapClient.insert("dbo_ASYNC_JOB.insert", record);
	...
	public Integer insertAsyncJobSelective(AsyncJob record) throws SQLException {
		Object newKey = sqlMapClient.insert("dbo_ASYNC_JOB.insertSelective", record);
		return (Integer) newKey;
	}
	...
	public List<AsyncJob> selectAsyncJobByExample(AsyncJobExample example) throws SQLException {
		List<AsyncJob> list = sqlMapClient.queryForList("dbo_ASYNC_JOB.selectByExample", example);
		return list;
	}
	...
	public AsyncJob selectAsyncJobByPrimaryKey(Integer id) throws SQLException {
		AsyncJob _key = new AsyncJob();
		_key.setId(id);
		AsyncJob record = (AsyncJob) sqlMapClient.queryForObject("dbo_ASYNC_JOB.selectByPrimaryKey", _key);
		return record;
	}
	...
	public int updateAsyncJobByExampleSelective(AsyncJob record, AsyncJobExample example) throws SQLException {
		...
		int rows = sqlMapClient.update("dbo_ASYNC_JOB.updateByExampleSelective", parms);
		return rows;
	}
	...
	public int updateAsyncJobByExample(AsyncJob record, AsyncJobExample example) throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = sqlMapClient.update("dbo_ASYNC_JOB.updateByExample", parms);
		return rows;
	}
	...
	public int updateAsyncJobByPrimaryKeySelective(AsyncJob record) throws SQLException {
		int rows = sqlMapClient.update("dbo_ASYNC_JOB.updateByPrimaryKeySelective", record);
		return rows;
	}
	...
	public int updateAsyncJobByPrimaryKey(AsyncJob record) throws SQLException {
		int rows = sqlMapClient.update("dbo_ASYNC_JOB.updateByPrimaryKey", record);
		return rows;
	}

	/**
	 * This class was generated by MyBatis Generator. This class corresponds to the database table dbo.ASYNC_JOB
	 * @mbggenerated  Fri Jul 05 18:45:21 ART 2013
	 */
