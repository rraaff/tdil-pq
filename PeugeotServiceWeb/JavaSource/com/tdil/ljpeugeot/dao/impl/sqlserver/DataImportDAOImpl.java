...
public class DataImportDAOImpl implements DataImportDAO {
     ...
     * This field corresponds to the database table dbo.DATA_IMPORT
     *
     ...
     * This method corresponds to the database table dbo.DATA_IMPORT
     *
     * @mbggenerated Sat Feb 01 15:35:30 ART 2014
     */
    ...
    public int countDataImportByExample(DataImportExample example) throws SQLException {
        Integer count = (Integer)  sqlMapClient.queryForObject("dbo_DATA_IMPORT.countByExample", example);
        return count;
    }
    ...
    public int deleteDataImportByExample(DataImportExample example) throws SQLException {
        int rows = sqlMapClient.delete("dbo_DATA_IMPORT.deleteByExample", example);
        return rows;
    }
    ...
    public int deleteDataImportByPrimaryKey(Integer id) throws SQLException {
        ...
        _key.setId(id);
        int rows = sqlMapClient.delete("dbo_DATA_IMPORT.deleteByPrimaryKey", _key);
        return rows;
    }
    ...
    public Integer insertDataImport(DataImport record) throws SQLException {
        Object newKey = sqlMapClient.insert("dbo_DATA_IMPORT.insert", record);
    ...
    public Integer insertDataImportSelective(DataImport record) throws SQLException {
        Object newKey = sqlMapClient.insert("dbo_DATA_IMPORT.insertSelective", record);
        return (Integer) newKey;
    }
    ...
    public List<DataImport> selectDataImportByExample(DataImportExample example) throws SQLException {
        List<DataImport> list = sqlMapClient.queryForList("dbo_DATA_IMPORT.selectByExample", example);
        return list;
    }
    ...
    public DataImport selectDataImportByPrimaryKey(Integer id) throws SQLException {
        DataImport _key = new DataImport();
        _key.setId(id);
        DataImport record = (DataImport) sqlMapClient.queryForObject("dbo_DATA_IMPORT.selectByPrimaryKey", _key);
        return record;
    }
    ...
    public int updateDataImportByExampleSelective(DataImport record, DataImportExample example) throws SQLException {
        ...
        int rows = sqlMapClient.update("dbo_DATA_IMPORT.updateByExampleSelective", parms);
        return rows;
    }
    ...
    public int updateDataImportByExample(DataImport record, DataImportExample example) throws SQLException {
        UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
        int rows = sqlMapClient.update("dbo_DATA_IMPORT.updateByExample", parms);
        return rows;
    }
    ...
    public int updateDataImportByPrimaryKeySelective(DataImport record) throws SQLException {
        int rows = sqlMapClient.update("dbo_DATA_IMPORT.updateByPrimaryKeySelective", record);
        return rows;
    }
    ...
    public int updateDataImportByPrimaryKey(DataImport record) throws SQLException {
        int rows = sqlMapClient.update("dbo_DATA_IMPORT.updateByPrimaryKey", record);
        return rows;
    }

    /**
     * This class was generated by MyBatis Generator.
     * This class corresponds to the database table dbo.DATA_IMPORT
     *
     * @mbggenerated Sat Feb 01 15:35:30 ART 2014
     */
