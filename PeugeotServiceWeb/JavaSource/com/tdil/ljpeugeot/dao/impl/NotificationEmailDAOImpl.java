...
public class NotificationEmailDAOImpl implements NotificationEmailDAO {
	...
	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table NOTIFICATION_EMAIL
	 * @mbggenerated  Mon Feb 03 23:13:01 ART 2014
	 */
	@SuppressWarnings("unchecked")
	public List<NotificationEmail> selectNotificationEmailByExampleWithBLOBs(NotificationEmailExample example) throws SQLException {
		List<NotificationEmail> list = sqlMapClient.queryForList("NOTIFICATION_EMAIL.selectByExampleWithBLOBs", example);
		return list;
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<NotificationEmail> selectNotificationEmailByExampleWithoutBLOBs(NotificationEmailExample example) throws SQLException {
	...
	public NotificationEmail selectNotificationEmailByPrimaryKey(Integer id) throws SQLException {
		NotificationEmail _key = new NotificationEmail();
		_key.setId(id);
		NotificationEmail record = (NotificationEmail) sqlMapClient.queryForObject("NOTIFICATION_EMAIL.selectByPrimaryKey", _key);
		return record;
	}
	 ...
	 * @mbggenerated  Mon Feb 03 23:13:01 ART 2014
	 */
	public int updateNotificationEmailByExampleWithBLOBs(NotificationEmail record, NotificationEmailExample example) throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
	 ...
	 * @mbggenerated  Mon Feb 03 23:13:01 ART 2014
	 */
	public int updateNotificationEmailByExampleWithoutBLOBs(NotificationEmail record, NotificationEmailExample example) throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
	...
	public List<NotificationEmail> selectNotificationEmailByExample(NotificationEmailExample example) throws SQLException {
		return selectNotificationEmailByExampleWithBLOBs(example);
	}
	@Override
	public int updateNotificationEmailByExample(NotificationEmail record, NotificationEmailExample example) throws SQLException {
		return updateNotificationEmailByExampleWithBLOBs(record, example);
	}
	@Override
	public int updateNotificationEmailByPrimaryKey(NotificationEmail record) throws SQLException {
		return updateNotificationEmailByPrimaryKeyWithBLOBs(record);
	}
}