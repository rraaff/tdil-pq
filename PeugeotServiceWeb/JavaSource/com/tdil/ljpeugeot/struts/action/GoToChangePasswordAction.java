...
public class GoToChangePasswordAction extends AbstractAction {
	
	@Override
	protected ActionForward basicExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		ChangePasswordForm aForm = (ChangePasswordForm)form;
		try {
			aForm.reset();
	...
	private static Logger getLog() {
		return LoggerProvider.getLogger(GoToChangePasswordAction.class);
	}
