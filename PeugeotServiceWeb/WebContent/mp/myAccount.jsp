...
<div id="layerContent" class="layerOnTop" style="display: none;">
	<div id="myAccount">
		<div id="links" align="center"><a href="../index.jsp">back to the home page</a>  .  <a href="catalog.jsp">Rewards Catalog</a>  .  <a href="shipments.jsp">Shipment Status</a>  .  <a href="javascript:verLegales();" id="legales" title="Legal">Legal</a></div>
	</div>
</div>
<!-- Layer legales -->
