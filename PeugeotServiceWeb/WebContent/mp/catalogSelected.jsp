...
<div id="layerContent" class="layerOnTop" style="display: none;">
	<div id="catalog">
		<div id="select"><img src="../images/skin_nrg2/mp/selected.jpg" width="181" height="125"></div>
		<div id="btn_unselected"><a href="tradeoff.jsp" title="Trade-off now!"><img src="../images/skin_nrg2/buttons/btn_tradeOff_on.png" width="234" height="82"></a></div>
