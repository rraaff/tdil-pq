				...
				<div class="table_services">
					...
					%>
						<ul class="table_body" id="vehicleTable">
							...
							<% } %>
							<li rel="ve-<%=vehicleValueObject.getVehicle().getId()%>" onclick="addService('<%=vehicleValueObject.getVehicle().getDomain()%>',<%=vehicleValueObject.getVehicle().getId()%>,'<%=modelName%>')" class="lastservkm"><span class="tag_for_mmobile">Kilometraje del último service: </span><%=vehicleValueObject.getVehicle().getLastservicekm() != null ? formateador.format(vehicleValueObject.getVehicle().getLastservicekm()) : "-"%></li>
							<li rel="ve-<%=vehicleValueObject.getVehicle().getId()%>" onclick="addService('<%=vehicleValueObject.getVehicle().getDomain()%>',<%=vehicleValueObject.getVehicle().getId()%>,'<%=modelName%>')" class="lastservdate"><span class="tag_for_mmobile">Fecha de último service: </span><%=vehicleValueObject.getVehicle().getLastservicedate() != null ? DateUtils.formatDateSp(vehicleValueObject.getVehicle().getLastservicedate()) : "-"%></li>
						</ul>
					<% } %>
				</div>
			<% } %>
