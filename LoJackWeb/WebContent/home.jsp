...
<div id="structure">
	<div id="content">
		...
		<div id="activities">
			<%
				if (websiteUser.appliesToActivity("BarNights")) { com.tdil.lojack.utils.ThalamusWebUtils.loginToActivity(websiteUser, "BarNights");
			%>
				<%
					if (websiteUser.appliesToActivity("University")) { com.tdil.lojack.utils.ThalamusWebUtils.loginToActivity(websiteUser, "University");
				%>
					<%
						if (websiteUser.appliesToActivity("NRG")) { com.tdil.lojack.utils.ThalamusWebUtils.loginToActivity(websiteUser, "NRG");
					%>
						<!-- composición 1 + 2 + 3 -->
						<span class="errorField">Que ondaaaaa</span>
