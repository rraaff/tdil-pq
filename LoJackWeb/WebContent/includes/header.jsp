<header class="menuInternas"  style="display: inline-block;">
	<div class="userLoggedThanlamusMenu">
		<ul class="correctNav">
			<li><a href="javascript:changeAvatar();"><% if (websiteUser.getModelUser().getIdAvatar() != null && !websiteUser.getModelUser().getIdAvatar().equals(0)) { %>
			...
			<% } else { %>
				<img id="avatarImg" src="boImages/na.gif" width="30" height="30" align="absmiddle"> 
			<% } %></a></li>
