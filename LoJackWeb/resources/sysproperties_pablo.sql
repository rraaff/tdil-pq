INSERT INTO SYSPROPERTIES (propKey,propValue,description,deleted) VALUES('front.server','http://192.168.252.108:8180/LoJackWeb','front.server',0);
INSERT INTO SYSPROPERTIES (propKey,propValue,description,deleted) VALUES('thalamus.server','http://192.168.252.108:8280/ThalamusWeb/','thalamus.server',0);
...
INSERT INTO SYSPROPERTIES (propKey,propValue,description,deleted) VALUES('gis.server','http://192.168.252.108:8180/GISWeb/gis/','gis.server',0);
INSERT INTO SYSPROPERTIES (propKey,propValue,description,deleted) VALUES('services.server','http://192.168.252.108:8180/GISWeb/services/','services.server',0);
