...
public class DeactivateAlarmForm extends AlarmForm {
	...
	public void save() throws SQLException, ValidationException {
		try {
			...
			alarm.setIdEntidad(getIdEntidad());
			if (getSessionUser().hasJobInProgress(alarm)) {
				...
				AsyncJobResponse jobResponse = LoJackServicesConnector.deactivateAlarm(getSessionUser(), idEntidad);
