...
public class ActivateLightRandomSequenceActionMobile extends AjaxAction {
	...
	protected ActionForward basicExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if (!sessionUser.hasJobInProgress(light)) {
			AsyncJobResponse jobResponse = LoJackServicesConnector.activateLightRandomSequence(sessionUser, idEntidad, idLuz);
		}
