...
public class TunOffLightActionMobile extends AjaxAction {
	...
	protected ActionForward basicExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if (!sessionUser.hasJobInProgress(light)) {
			AsyncJobResponse jobResponse = LoJackServicesConnector.deactivateLight(sessionUser, idEntidad, idLuz);
		}
