...
public class MoveCameraSocketServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if (LoJackWebUtils.isHomeUserLogged(req)) {
			...
			try {
				...
				request.append(req.getParameter("dir")).append("\n");
	...
	private static Logger getLog() {
		return LoggerProvider.getLogger(MoveCameraSocketServlet.class);
	}
