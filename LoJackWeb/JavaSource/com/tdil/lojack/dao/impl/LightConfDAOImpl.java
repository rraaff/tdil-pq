...
public class LightConfDAOImpl implements LightConfDAO {
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public int countLightConfByExample(LightConfExample example)
			throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"LIGHT_CONF.countByExample", example);
		return count;
	}
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public int deleteLightConfByExample(LightConfExample example)
			throws SQLException {
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public Integer insertLightConfSelective(LightConf record)
			throws SQLException {
		Object newKey = sqlMapClient.insert("LIGHT_CONF.insertSelective",
				record);
		return (Integer) newKey;
	}
	...
	public List<LightConf> selectLightConfByExample(LightConfExample example)
			throws SQLException {
		List<LightConf> list = sqlMapClient.queryForList(
				"LIGHT_CONF.selectByExample", example);
		return list;
	}
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public LightConf selectLightConfByPrimaryKey(Integer id)
			throws SQLException {
		LightConf _key = new LightConf();
		_key.setId(id);
		LightConf record = (LightConf) sqlMapClient.queryForObject(
				"LIGHT_CONF.selectByPrimaryKey", _key);
		return record;
	}
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public int updateLightConfByExampleSelective(LightConf record,
			LightConfExample example) throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = sqlMapClient.update("LIGHT_CONF.updateByExampleSelective",
				parms);
		return rows;
	}
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public int updateLightConfByExample(LightConf record,
			LightConfExample example) throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public int updateLightConfByPrimaryKeySelective(LightConf record)
			throws SQLException {
		int rows = sqlMapClient.update(
				"LIGHT_CONF.updateByPrimaryKeySelective", record);
		return rows;
	}
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public int updateLightConfByPrimaryKey(LightConf record)
			throws SQLException {
