...
public class AlarmConfDAOImpl implements AlarmConfDAO {
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public int countAlarmConfByExample(AlarmConfExample example)
			throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"ALARM_CONF.countByExample", example);
		return count;
	}
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public int deleteAlarmConfByExample(AlarmConfExample example)
			throws SQLException {
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public Integer insertAlarmConfSelective(AlarmConf record)
			throws SQLException {
		Object newKey = sqlMapClient.insert("ALARM_CONF.insertSelective",
				record);
		return (Integer) newKey;
	}
	...
	public List<AlarmConf> selectAlarmConfByExample(AlarmConfExample example)
			throws SQLException {
		List<AlarmConf> list = sqlMapClient.queryForList(
				"ALARM_CONF.selectByExample", example);
		return list;
	}
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public AlarmConf selectAlarmConfByPrimaryKey(Integer id)
			throws SQLException {
		AlarmConf _key = new AlarmConf();
		_key.setId(id);
		AlarmConf record = (AlarmConf) sqlMapClient.queryForObject(
				"ALARM_CONF.selectByPrimaryKey", _key);
		return record;
	}
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public int updateAlarmConfByExampleSelective(AlarmConf record,
			AlarmConfExample example) throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = sqlMapClient.update("ALARM_CONF.updateByExampleSelective",
				parms);
		return rows;
	}
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public int updateAlarmConfByExample(AlarmConf record,
			AlarmConfExample example) throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public int updateAlarmConfByPrimaryKeySelective(AlarmConf record)
			throws SQLException {
		int rows = sqlMapClient.update(
				"ALARM_CONF.updateByPrimaryKeySelective", record);
		return rows;
	}
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public int updateAlarmConfByPrimaryKey(AlarmConf record)
			throws SQLException {
