...
public class AlarmConfDAOImpl implements AlarmConfDAO {
	...
	/**
	 * This field was generated by MyBatis Generator. This field corresponds to the database table dbo.ALARM_CONF
	 * @mbggenerated  Fri Jul 05 18:45:21 ART 2013
	 */
	private SqlMapClient sqlMapClient;

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table dbo.ALARM_CONF
	 * @mbggenerated  Fri Jul 05 18:45:21 ART 2013
	 */
	...
	public int countAlarmConfByExample(AlarmConfExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject("dbo_ALARM_CONF.countByExample", example);
		return count;
	}
	...
	public int deleteAlarmConfByExample(AlarmConfExample example) throws SQLException {
		int rows = sqlMapClient.delete("dbo_ALARM_CONF.deleteByExample", example);
		return rows;
	}
	...
	public int deleteAlarmConfByPrimaryKey(Integer id) throws SQLException {
		...
		_key.setId(id);
		int rows = sqlMapClient.delete("dbo_ALARM_CONF.deleteByPrimaryKey", _key);
		return rows;
	}
	...
	public Integer insertAlarmConf(AlarmConf record) throws SQLException {
		Object newKey = sqlMapClient.insert("dbo_ALARM_CONF.insert", record);
	...
	public Integer insertAlarmConfSelective(AlarmConf record) throws SQLException {
		Object newKey = sqlMapClient.insert("dbo_ALARM_CONF.insertSelective", record);
		return (Integer) newKey;
	}
	...
	public List<AlarmConf> selectAlarmConfByExample(AlarmConfExample example) throws SQLException {
		List<AlarmConf> list = sqlMapClient.queryForList("dbo_ALARM_CONF.selectByExample", example);
		return list;
	}
	...
	public AlarmConf selectAlarmConfByPrimaryKey(Integer id) throws SQLException {
		AlarmConf _key = new AlarmConf();
		_key.setId(id);
		AlarmConf record = (AlarmConf) sqlMapClient.queryForObject("dbo_ALARM_CONF.selectByPrimaryKey", _key);
		return record;
	}
	...
	public int updateAlarmConfByExampleSelective(AlarmConf record, AlarmConfExample example) throws SQLException {
		...
		int rows = sqlMapClient.update("dbo_ALARM_CONF.updateByExampleSelective", parms);
		return rows;
	}
	...
	public int updateAlarmConfByExample(AlarmConf record, AlarmConfExample example) throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = sqlMapClient.update("dbo_ALARM_CONF.updateByExample", parms);
		return rows;
	}
	...
	public int updateAlarmConfByPrimaryKeySelective(AlarmConf record) throws SQLException {
		int rows = sqlMapClient.update("dbo_ALARM_CONF.updateByPrimaryKeySelective", record);
		return rows;
	}
	...
	public int updateAlarmConfByPrimaryKey(AlarmConf record) throws SQLException {
		int rows = sqlMapClient.update("dbo_ALARM_CONF.updateByPrimaryKey", record);
		return rows;
	}

	/**
	 * This class was generated by MyBatis Generator. This class corresponds to the database table dbo.ALARM_CONF
	 * @mbggenerated  Fri Jul 05 18:45:21 ART 2013
	 */
