...
public class AsyncJobDAOImpl implements AsyncJobDAO {
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public int countAsyncJobByExample(AsyncJobExample example)
			throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"ASYNC_JOB.countByExample", example);
		return count;
	}
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public int deleteAsyncJobByExample(AsyncJobExample example)
			throws SQLException {
	...
	public Integer insertAsyncJobSelective(AsyncJob record) throws SQLException {
		Object newKey = sqlMapClient
				.insert("ASYNC_JOB.insertSelective", record);
		return (Integer) newKey;
	}
	...
	public List<AsyncJob> selectAsyncJobByExample(AsyncJobExample example)
			throws SQLException {
		List<AsyncJob> list = sqlMapClient.queryForList(
				"ASYNC_JOB.selectByExample", example);
		return list;
	}
	...
	public AsyncJob selectAsyncJobByPrimaryKey(Integer id) throws SQLException {
		AsyncJob _key = new AsyncJob();
		_key.setId(id);
		AsyncJob record = (AsyncJob) sqlMapClient.queryForObject(
				"ASYNC_JOB.selectByPrimaryKey", _key);
		return record;
	}
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public int updateAsyncJobByExampleSelective(AsyncJob record,
			AsyncJobExample example) throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = sqlMapClient.update("ASYNC_JOB.updateByExampleSelective",
				parms);
		return rows;
	}
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public int updateAsyncJobByExample(AsyncJob record, AsyncJobExample example)
			throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
	 ...
	 * @mbggenerated  Sat May 04 15:44:50 ART 2013
	 */
	public int updateAsyncJobByPrimaryKeySelective(AsyncJob record)
			throws SQLException {
		int rows = sqlMapClient.update("ASYNC_JOB.updateByPrimaryKeySelective",
				record);
		return rows;
	}
