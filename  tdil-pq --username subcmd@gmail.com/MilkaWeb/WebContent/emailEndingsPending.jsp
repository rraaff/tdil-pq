...
<div id="container">
	...
	<div class="renglon width860" style="margin-bottom:20px;">
		<display:table name="test" sort="external" pagesize="10" id="testit">
			...
			<display:column title="acciones"><a href="./reviewEmailEndings.do?id=<%= ((EmailEndingsValueObject)pageContext.getAttribute("testit")).getId()%>&page=<%= request.getParameter("page") != null ? request.getParameter("page") : "1" %>">Revisar</a></display:column>
		</display:table>
	</div>
		...
		<div class="renglon width860" style="margin-top:20px; border:dotted 1px #CCCCCC;">
			...
			<html:form method="POST" action="/approveDisapproveEmailEndings">
				<div style="width:400px; height:200px; float:left;">
					...
					<div class="label width80">URL:</div><bean:write name="EmailEndingsAdministrationForm" property="urlLink"/> <a href="./goToLinkTargetSelectionFromEmail.do">Seleccion de link</a> - <a href="./clearLinkTargetEmailEndings.do">Borrar link</a><br><br>
