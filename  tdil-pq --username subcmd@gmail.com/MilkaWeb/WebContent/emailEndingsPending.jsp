...
<div id="container">
	...
	<div class="renglon width860" style="margin-bottom:20px;">
		<display:table name="test" sort="external" pagesize="10" id="testit">
			...
			<display:column title="acciones"><a href="./reviewEmailEndings.do?id=<%= ((EmailEndingsValueObject)pageContext.getAttribute("testit")).getId()%><%=DisplayTagParamHelper.getParams(request)%>">Revisar</a></display:column>
		</display:table>
	</div>
