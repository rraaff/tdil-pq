...
<title>Milka.com.ar | Nuestros Chocolates - Tabletas de Chocolate Rellenas</title>
...
#galeria_productos #galeria_parte_1 {
	background:url(images/productos/tabletas_rellenas_comp1.jpg) no-repeat 0 0;	
	width:488px;
	height:423px;
	margin:5px 0 0 5px;
}
#galeria_productos #galeria_parte_2 {
	background:url(images/productos/tabletas_rellenas_comp2.jpg) no-repeat 0 0;	
	width:488px;
	height:423px;
	margin:5px 0 0 5px;
}
		...
		<div id="gallery_container2">
			<div id="thumb_container2">
				<div id="thumbs2">
					...
					<div class="thumbnail" style="width:80px;"><a href="#" rel="lightbox[galerie]"><img src="images/productos/thmb/thmb_Milka_Soft_Avellanas_150_gr.jpg" width="80" height="119" /></a>Milka Soft Avellanas 150 gr.</div>
					<div class="thumbnail" style="width:80px;"><a href="#" rel="lightbox[galerie]"><img src="images/productos/thmb/thmb_Milka_Soft_Capuccino_150_gr.jpg" width="80" height="119" /></a>Milka Soft Capuccino 150 gr.</div>
					<div class="thumbnail" style="width:80px;"><a href="#" rel="lightbox[galerie]"><img src="images/productos/thmb/thmb_Milka_Dulce_de_Leche_30_gr.jpg" width="80" height="119" /></a>Milka Dulce de Leche 30 gr.</div>
					<div class="thumbnail" style="width:80px;"><a href="#" rel="lightbox[galerie]"><img src="images/productos/thmb/thmb_Milka_Dulce_de_Leche_Blanco_30_gr.jpg" width="80" height="119" /></a>Milka Dulce de Leche Blanco 30 gr.</div>
				</div>
			</div>
		</div>
