		...
		<div id="box">
			...
			<div id="social">
				<ul>
					...
					<li class="facebook"><a href="javascript:facebookShare('Milka Argentina | Sitio oficial | ' + document.title ,'Hay tanta dulzura para compartir','www.milka.com.ar/',location.href);" title="Facebook"><img src="images/facebook.png" width="22" height="22" alt="Facebook" border="none" /></a></li>
