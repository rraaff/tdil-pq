...
public class MailToParentAdministrationForm extends TransactionalValidationForm implements ApproveDisapproveForm , AjaxUploadHandlerForm, LinkAnchorForm {
	...
	public void approve() throws SQLException, ValidationException {
		...
		/** Inicio del email */
		com.tdil.milka.web.EmailUtils.sendContentApprovedEmail(mailToParent.getIdAuthor(), com.tdil.milka.web.EmailUtils.cartasdehijosapadres, SystemPropertiesKeys.CARTAS_DE_HIJOS_A_PADRES_URL, mailToParent.getId());
	}
