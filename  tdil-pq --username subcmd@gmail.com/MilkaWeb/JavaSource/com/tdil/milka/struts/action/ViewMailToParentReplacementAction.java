...
import com.tdil.milka.struts.forms.MailToParentAdministrationForm;
import com.tdil.struts.actions.AbstractAction;
import com.tdil.struts.forms.UploadData;

public class ViewMailToParentReplacementAction extends AbstractAction {

	@Override
	protected ActionForward basicExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		MailToParentAdministrationForm noteForm = (MailToParentAdministrationForm) form;
