...
import com.tdil.milka.struts.forms.GoodMorningAdministrationForm;
import com.tdil.struts.actions.AbstractAction;
import com.tdil.struts.forms.UploadData;

public class ViewGoodMorningReplacementAction extends AbstractAction {

	@Override
	protected ActionForward basicExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		GoodMorningAdministrationForm noteForm = (GoodMorningAdministrationForm) form;
