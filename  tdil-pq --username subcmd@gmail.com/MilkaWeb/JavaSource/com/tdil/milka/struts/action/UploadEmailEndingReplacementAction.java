...
public class UploadEmailEndingReplacementAction extends AjaxFileUploadAction {

	@Override
	protected AjaxUploadHandlerForm getUploadForm(HttpServletRequest request, ActionForm form) {
		return (AjaxUploadHandlerForm)request.getSession().getAttribute("EmailEndingsAdministrationForm");
	}
