...
public class GoToLinkTargetSelectionFromPapapediaAction extends AbstractAction {

	@Override
	protected ActionForward basicExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		LinkAnchorForm linkSource = (LinkAnchorForm)request.getSession().getAttribute("PapapediaAdministrationForm");
