...
public class UploadNoteNewsThumbAction extends AbstractAction {
	...
	protected ActionForward basicExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		try {
			noteForm.uploadNewsThumb(error);
			if(error.hasError()) {
	...
	private static Logger getLog() {
		return LoggerProvider.getLogger(UploadNoteNewsThumbAction.class);
	}
