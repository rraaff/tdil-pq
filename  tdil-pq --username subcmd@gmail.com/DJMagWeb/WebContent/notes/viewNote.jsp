	...
	<div id="fakeLiveboxWindow">
		...
		<div id="left">
			...
			<div id="navBar">
				...
				<!--a href="javascript:window.open('https://twitter.com/share?url=' + encodeURIComponent(location.href)); return false;"><img src="../../../images/buttons/sharetw.gif" width="70" height="20" align="absmiddle"></a-->
				</div>
