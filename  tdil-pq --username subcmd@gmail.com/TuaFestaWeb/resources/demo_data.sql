insert into PROF_PROD_CATEGORY values (1, 'Consumibles', 'Consumibles', 0, 0);
insert into PROF_PROD_CATEGORY values (2, 'Tortas', 'Tortas', 1, 0);
insert into PROF_PROD_CATEGORY values (4, 'Tartas', 'Tartas', 1, 0);
insert into PROF_PROD_CATEGORY values (3, 'Cotillon', 'Cotillon', 0, 0);

insert into PROF_PROD_CATEGORY values (5, 'Budin', 'Budin', 2, 0);
insert into PROF_PROD_CATEGORY values (6, 'Bizcochuelo', 'Bizcochuelo', 2, 0);

insert into PROF_PROD_CATEGORY values (7, 'Coco', 'Coco', 4, 0);
insert into PROF_PROD_CATEGORY values (8, 'Pasta Frola', 'Pasta Frola', 4, 0);
