...
import com.tdil.tuafesta.struts.forms.ValidateClientEmailForm;

public class ValidateClientEmailAction extends SaveAction {

	@Override
	public ActionForward validateAndSave(AbstractForm form, HttpServletRequest request, ActionMapping mapping) {
		final ValidateClientEmailForm validateProfesionalEmailForm = (ValidateClientEmailForm)form;
