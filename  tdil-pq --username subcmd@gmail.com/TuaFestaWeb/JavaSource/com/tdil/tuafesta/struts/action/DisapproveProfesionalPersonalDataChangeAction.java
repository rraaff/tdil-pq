...
public class DisapproveProfesionalPersonalDataChangeAction extends AbstractAction {
	
	private static final Logger LOG = LoggerProvider.getLogger(DisapproveProfesionalPersonalDataChangeAction.class);
		...
		try {
			TransactionProvider.executeInTransaction(new TransactionalAction() {
				public void executeInTransaction() throws SQLException, ValidationException {
					approveDisapproveForm.disapprovePersonalDataChange();
				}
			});
