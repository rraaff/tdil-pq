...
public class ProfesionalProductDAOImpl implements ProfesionalProductDAO {
    ...
    public List<ProfesionalProduct> selectProfesionalProductByExample(ProfesionalProductExample example) throws SQLException {
    ...
    public ProfesionalProduct selectProfesionalProductByPrimaryKey(Integer id) throws SQLException {
        ProfesionalProduct _key = new ProfesionalProduct();
        _key.setId(id);
        ProfesionalProduct record = (ProfesionalProduct) sqlMapClient.queryForObject("PROF_PRODUCT.selectByPrimaryKey", _key);
        return record;
    }
     ...
     * @mbggenerated Fri Aug 03 18:15:40 ART 2012
     */
    public int updateProfesionalProductByExampleSelective(ProfesionalProduct record, ProfesionalProductExample example) throws SQLException {
     ...
     * @mbggenerated Fri Aug 03 18:15:40 ART 2012
     */
    public int updateProfesionalProductByExample(ProfesionalProduct record, ProfesionalProductExample example) throws SQLException {
        UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
