...
public class PromotionPhotoDAOImpl implements PromotionPhotoDAO {
    ...
    public PromotionPhoto selectPromotionPhotoByPrimaryKey(Integer id) throws SQLException {
        PromotionPhoto _key = new PromotionPhoto();
        _key.setId(id);
        PromotionPhoto record = (PromotionPhoto) sqlMapClient.queryForObject("PROMOTION_PHOTO.selectByPrimaryKey", _key);
        return record;
    }
     ...
     * @mbggenerated Mon Aug 20 20:10:42 ART 2012
     */
    public int updatePromotionPhotoByExampleSelective(PromotionPhoto record, PromotionPhotoExample example) throws SQLException {
