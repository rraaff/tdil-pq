...
public class HighlightedCategoryDAOImpl implements HighlightedCategoryDAO {
     ...
     * This field corresponds to the database table HIGHLIGHTED_CAT
     *
     ...
     * This method corresponds to the database table HIGHLIGHTED_CAT
     *
     * @mbggenerated Sun Aug 26 20:37:47 ART 2012
     */
    ...
    public List<HighlightedCategory> selectHighlightedCategoryByExample(HighlightedCategoryExample example) throws SQLException {
    ...
    public HighlightedCategory selectHighlightedCategoryByPrimaryKey(Integer id) throws SQLException {
        HighlightedCategory _key = new HighlightedCategory();
        _key.setId(id);
        HighlightedCategory record = (HighlightedCategory) sqlMapClient.queryForObject("HIGHLIGHTED_CAT.selectByPrimaryKey", _key);
        return record;
    }
     ...
     * @mbggenerated Sun Aug 26 20:37:47 ART 2012
     */
    public int updateHighlightedCategoryByExampleSelective(HighlightedCategory record, HighlightedCategoryExample example) throws SQLException {
     ...
     * @mbggenerated Sun Aug 26 20:37:47 ART 2012
     */
    public int updateHighlightedCategoryByExample(HighlightedCategory record, HighlightedCategoryExample example) throws SQLException {
        UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
