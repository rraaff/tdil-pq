...
public class WallWrittingDAOImpl implements WallWrittingDAO {
	...
	@Override
	public List<WallWrittingValueObject> selectWallWindow(Map<String, Object> params) throws SQLException {
		List<WallWrittingValueObject> list = sqlMapClient.queryForList("WALL_WRITTING.selectWallWindow", params);
		return list;
	}
	
	@Override
	public List<WallWrittingValueObject> selectWallWrittingPending(int id) throws SQLException {
		Map<String, Object> params= new HashMap<String, Object>();
		params.put("idWall", id);
		List<WallWrittingValueObject> list = sqlMapClient.queryForList("WALL_WRITTING.selectWallWrittingPending", params);
		return list;
	}
	
	@Override
	public List<WallWrittingValueObject> selectWallWindowAll(Map<String, Object> params) throws SQLException {
		List<WallWrittingValueObject> list = sqlMapClient.queryForList("WALL_WRITTING.selectWallWindowAll", params);
		return list;
	}
}