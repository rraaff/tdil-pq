	...
	<div id="content">
		...
		<html:form method="POST" action="/saveProfesionalServices">
			...
			<div class="myRow" id="addservicelayer">
				...
				<a class="nonelyLink" id="addService">Agregar servicio</a>
				</div>
				...
				<div id="addSellLayer" style="<%=EditProfesionalSellForm.isEdition() ? "" : "display: none;"%>
					...
					<a href="javascript:document.EditProfesionalSellForm.action='./editProfesionalServicesAddSell.do';document.EditProfesionalSellForm.submit();" id="doAddSell">Guardar</a>&nbsp;<a href="#" id="cancelAddSell">Cancelar</a>
				</div>
			</div>
			...
			<div class="myRow">
				...
				<display:table name="sells" sort="external" pagesize="10" id="sells" requestURI="./registroProfesional.jsp">
					...
					<display:column title="acciones" headerClass="sortable width50">
						...
						<a class="nonelyLink" href="javascript:document.EditProfesionalSellForm.action='./editRemoveService.do?index=<%= ((SellBean)pageContext.getAttribute("sells")).getIndex()%>';document.EditProfesionalSellForm.submit();">Quitar</a>
					</display:column>
				</display:table>
