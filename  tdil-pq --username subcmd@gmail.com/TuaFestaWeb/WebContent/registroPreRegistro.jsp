	...
	<div id="content">
		...
		<div id="formContent">
			<div id="moduloPreReg" class="cliente">
				...
				<p>Podes registrarte sin costo alguno usando tu cuenta de Facebook o <a href="" title="Registrate sin usar tu cuenta de Facebook">simplemente cargando unos datos b&aacute;sicos.</a></p>
